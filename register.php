		...
		if($password != $repassword){
			...
			if($row['numrows'] > 0){
				...
				// try{
					...
					if ($stmt) {
						// $_SESSION['sucess'] = 'Thank you for Registering.';
						// echo '<scr alert("Thank you for Registering.")';
						$_SESSION['success'] = 'Register Sucessful Please LogIn.';
						header('location: signup.php');
					}
					else{
				    ...
				    //     $mail->SMTPAuth = true;                               
				    //     $mail->Username = 'razzsuwal@gmail.com';     
				    ...
				    //     $mail->setFrom('razzsuwal@gmail.com');
				        
				    //     //Recipients
				    //     $mail->addAddress($email);              
				    //     $mail->addReplyTo('razzsuwal@gmail.com');
